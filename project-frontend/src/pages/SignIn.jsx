...
const SignIn = (props) => {
    ...
    const SigninHandler = () => {
        ...
        setIsLoading(true);
        const POST_URL = 'http://localhost:8000/api/v1/user/signin';
        axios.post(POST_URL, {
            "email": email,
            "password": password
        }).then((response) => {
                    ...
                    <div className="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
                        <form className="login100-form validate-form">
                            ...
                            <div className="container-login100-form-btn">
                                <Link to="/signup" className="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
                                    <i className="fa fa-long-arrow-left m-l-5"></i> Sign Up
                                </Link>

                                <div className="wrap-login100-form-btn">
                                    <div className="login100-form-bgbtn"></div>
                                    <button className="login100-form-btn signin-button" onClick={SigninHandler}>
                                        Sign In
                                    </button>
                                </div>
                            </div>
