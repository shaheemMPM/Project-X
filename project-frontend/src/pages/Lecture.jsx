...
const Lecture = (props) => {
  ...
  const getLecture = () => {
    ...
    const GET_URL = `https://localhost:8883/api/v1/lecture/${lectureId}`;
    const header_config = {
  ...
  const getChat = () => {
    ...
    const GET_URL = `https://localhost:8883/api/v1/chat/${lectureId}`;
    const header_config = {
      headers: { Authorization: `Bearer ${token.token}` },
    };
    axios
  ...
  const createChat = () => {
    ...
    const POST_URL = `https://localhost:8883/api/v1/chat`;
    const header_config = {
      headers: { Authorization: `Bearer ${token.token}` },
    };
    axios
        ...
        <section className="lecture-section">
          <div className="lecture-left">
            <video className="video-player" controls>
              <source
                src={`https://localhost:8883/${lecture.url}`}
                type="video/mp4"
              />
